...
export default function DoubleRange({rangeMin ,rangeMax ,rangeStep , maxValue ,minValue ,setMax ,setMin}:DoupleRangeProps) {
  ...
  return (
    <div className='flex relative'>
        ...
        <input type="range" min={rangeMin} step={rangeStep} max={rangeMax} value={minValue} onChange={(e) => handleMinChange(e)} className='absolute pointer-events-auto appearance-none w-full h-1'/>
